...
from app.core.dispatch import DispatchResponse, UnitCountWithPacking, to_dispatch_response
...
async def test_order_dispatchs_returns_200(client: AsyncClient):
    ...
    response = await client.post(
        ...
        json=[{"ID": "1", "OrderID": "abc", "SKU": "la-tournee-penne-ble-semi-complet-bio-350", "UnitCount": 10}],
    )
